        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    create_at = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GetDate()"),
                    confirm_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                    pay_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                    update_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                    cancel_at = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCategory", x => new { x.cate_id, x.product_id });
                    table.ForeignKey(
                        name: "FK_ProductCategory_Category_cate_id",
                        column: x => x.cate_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ship_status = table.Column<int>(type: "int", nullable: false),
                    from_address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    to_address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    cod_price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    lading_code = table.Column<string>(type: "varchar(max)", unicode: false, nullable: true),
                    create_at = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GetDate()"),
                    cancel_at = table.Column<DateTime>(type: "datetime2", nullable: true),
